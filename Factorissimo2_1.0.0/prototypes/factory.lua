...
local factory_4 = function(suffix, localised_suffix, result_suffix, visible, count, sprite)
	local name = "factory-4" .. suffix
	local localised_name = {"entity-name.factory-4" .. localised_suffix}
	local result_name = "factory-4" .. result_suffix
	local item_flags
	if visible then item_flags = {} else item_flags = {"hidden"} end
	return {
		{
...
local factory_5 = function(suffix, localised_suffix, result_suffix, visible, count, sprite)
	local name = "factory-5" .. suffix
	local localised_name = {"entity-name.factory-5" .. localised_suffix}
	local result_name = "factory-5" .. result_suffix
	local item_flags
	if visible then item_flags = {} else item_flags = {"hidden"} end
	return {
		{
			...
			name = name,
			localised_name = localised_name,
			icon = F.."/graphics/icon/factory-5.png",
			icon_size = 32,
			flags = {"player-creation"},
			minable = {mining_time = 5, result = result_name, count = count},
			max_health = 5000,
...
local factory_6 = function(suffix, localised_suffix, result_suffix, visible, count, sprite)
	local name = "factory-6" .. suffix
	local localised_name = {"entity-name.factory-6" .. localised_suffix}
	local result_name = "factory-6" .. result_suffix
	local item_flags
	if visible then item_flags = {} else item_flags = {"hidden"} end
	return {
		{
			...
			name = name,
			localised_name = localised_name,
			icon = F.."/graphics/icon/factory-6.png",
			icon_size = 32,
			flags = {"player-creation"},
			minable = {mining_time = 5, result = result_name, count = count},
			max_health = 5000,
...
data:extend(factory_4("", "", "", true, 0, F.."/graphics/factory/factory-4.png"))
for i=10,99 do
	data:extend(factory_4("-s" .. i, "-s", "-s" .. i, false, 1, F.."/graphics/factory/factory-4-combined.png"))
end
data:extend(factory_4("-i", "-i", "", false, 1, F.."/graphics/factory/factory-4-combined.png"))

data:extend({
	{
		type = "simple-entity",
		name = "factory-4-overlay",
		flags = {"not-on-map"},
		minable = nil,
		max_health = 1,
		corpse = "big-remnants",
		...
		selectable_in_game = false,
		picture = {
			filename = F.."/graphics/factory/factory-4-combined.png",
			width = 704,
			height = 608,
			shift = {2, -7.09375},
		},
...
data:extend(factory_5("", "", "", true, 0, F.."/graphics/factory/factory-5.png"))
for i=10,99 do
	data:extend(factory_5("-s" .. i, "-s", "-s" .. i, false, 1, F.."/graphics/factory/factory-5-combined.png"))
end
data:extend(factory_5("-i", "-i", "", false, 1, F.."/graphics/factory/factory-5-combined.png"))

data:extend({
	{
		type = "simple-entity",
		name = "factory-5-overlay",
		flags = {"not-on-map"},
		minable = nil,
		max_health = 1,
		corpse = "big-remnants",
		...
		selectable_in_game = false,
		picture = {
			filename = F.."/graphics/factory/factory-5-combined.png",
			width = 704,
			height = 608,
			shift = {2, -7.09375},
		},
...
data:extend(factory_6("", "", "", true, 0, F.."/graphics/factory/factory-6.png"))
for i=10,99 do
	data:extend(factory_6("-s" .. i, "-s", "-s" .. i, false, 1, F.."/graphics/factory/factory-6-combined.png"))
end
data:extend(factory_6("-i", "-i", "", false, 1, F.."/graphics/factory/factory-6-combined.png"))

data:extend({
	{
		type = "simple-entity",
		name = "factory-6-overlay",
		flags = {"not-on-map"},
		minable = nil,
		max_health = 1,
		corpse = "big-remnants",
		...
		selectable_in_game = false,
		picture = {
			filename = F.."/graphics/factory/factory-6-combined.png",
			width = 704,
			height = 608,
			shift = {2, -7.09375},
		},
