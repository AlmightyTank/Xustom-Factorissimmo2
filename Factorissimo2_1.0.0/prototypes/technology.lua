...
data:extend({
	...
	{
		type = "technology",
		name = "factory-architecture-t4",
		icon = F.."/graphics/technology/factory-architecture-4.png",
		icon_size = 128,
		prerequisites = {"factory-architecture-t3"},
		effects = {
			{
				type = "unlock-recipe",
				recipe = "factory-4",
		...
		unit = {
			count = easy_research and 400 or 4000,
	...
	{
		type = "technology",
		name = "factory-architecture-t5",
		icon = F.."/graphics/technology/factory-architecture-5.png",
		icon_size = 128,
		prerequisites = {"factory-architecture-t4"},
		effects = {
			{
				type = "unlock-recipe",
				recipe = "factory-5",
	...
	{
		type = "technology",
		name = "factory-architecture-t6",
		icon = F.."/graphics/technology/factory-architecture-6.png",
		icon_size = 128,
		prerequisites = {"factory-architecture-t5"},
		effects = {
			{
				type = "unlock-recipe",
				recipe = "factory-6",
